   ...
   private:
    class Pixel
    {
       ...
       public:
        ...
        string GetInfo()
        {
            return "R = " + to_string(r) + "G = " + to_string(g) +
                   "B = " + to_string(b);
        }
    };
    static const int LENGHT = 5;
    Pixel pixels[LENGHT]{Pixel(4, 1, 99), Pixel(56, 3, 253), Pixel(98, 6, 223),
                         Pixel(21, 56, 43), Pixel(23, 66, 77)};
...
{
   public:
    GraphicCard(string GPUcompanyName, string RAMcompanyName)
        : GPU(GPUcompanyName), RAM(RAMcompanyName)
    {
